...
namespace Svn
{
    public static class SvnAssetsMenu
    {
        ...
        public static void OpenCommitWindow(string workDirectory, List<string> paths)
        {
            string pathStr = CombinePathString(paths);
            ExecuteTortoiseClient("/command:commit ",workDirectory, pathStr);
        }
        public static void OpenUpdateWindow(string workDirectory, List<string> paths)
        {
            string pathStr = CombinePathString(paths);
            ExecuteTortoiseClient("/command:update ",workDirectory, pathStr);
        }
        public static void OpenRevertWindow(string workDirectory, List<string> paths)
        {
            string pathStr = CombinePathString(paths);
